...
/* 八种颜色。w 是鉴定出这种颜色的权重（合计 100）——彩色稀有一点。 */
var ORB_COLORS = [
  {id:"red",     n:"红", c:"#B8322A", w:13},
  {id:"yellow",  n:"黄", c:"#C99A1E", w:13},
  {id:"green",   n:"绿", c:"#3F7A35", w:13},
  {id:"blue",    n:"蓝", c:"#2A62AD", w:13},
  {id:"purple",  n:"紫", c:"#6F3D98", w:13},
  {id:"white",   n:"白", c:"#E8E2D4", w:13},
  {id:"black",   n:"黑", c:"#2A2620", w:13},
  {id:"rainbow", n:"彩", c:"",        w:9}
];
