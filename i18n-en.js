...
"从这里往下，<b>练习模式</b>不再生效：没有 +50 护甲，攻击也不再减半。": "From here on down, <b>practice mode</b> no longer applies: no +50 armor, and your attack is no longer halved.",
...
"快": "Fast",
"自动": "Auto",
"这台设备没有这门语言的语音": "No voice for this language on this device",
"答题时间": "Time",
"秒": "s",
"不限时": "No limit",
"默认": "Default",
"答题不限时": "No time limit",
"口令输入成功：设置页多了「答题时间」，可以自己填秒数。": "Code success: Settings now has an answer-time box — type any number of seconds.",
"存档 Save": "Save",
...
"走开": "Walk away",
"金坛": "Gold altar",
"阶梯旁边立着一座金坛": "A gold altar stands by the stairs",
"投得越多，它回应得越重。": "The more you give, the more it answers.",
"你有": "You have",
"这一次": "This time",
"已得到": "So far",
"投入": "Offer",
...
"伤害": "Damage",
"受到的伤害": "Damage taken",
"阶梯旁边升起一座<b>金坛</b> —— 投进金币，换一项本局有效的属性加成。": "A <b>gold altar</b> rises beside the stairs — offer gold for a random stat bonus that lasts this run.",
"金坛吞下了 <b>": "The gold altar swallows <b>",
"</b> 金 —— <b>": "</b> gold — <b>",
"</b>（本局有效）。": "</b> (for this run).",
"金坛还立在阶梯旁边。这一层走之前，随时能回来再投。": "The gold altar still stands by the stairs. Come back and offer more before you leave this floor.",
